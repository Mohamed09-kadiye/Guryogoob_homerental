...
export function CreateRental() {
  return (
    ...
    >
      <span className="hidden md:block">Do Renting</span>{' '}
...
export function UpdateRental({ id }: { id: string }) {
  return (
    <Link
      href={`/dashboard/rentals/edit/${id}`} // Update the path with your actual edit route
...
export function DeleteRental({ id }: DeleteUsersProps) {
...
export function ProfileRental({ id }: { id: string }) {
  return (
    <Link
